  ...
  const navigation: NavItem[] = [
    {
      ...
      subMenu: [
        ...
        { label: 'Isolation Plancher Bas', href: '/isolation-plancher-bas-bas-rhin' },
      ],
    },
    {
      ...
      subMenu: [
        ...
        { label: 'Menuiseries & Volets', href: '/remplacement-fenetres-bas-rhin' },
        { label: 'Ventilation (VMC)', href: '/installation-vmc-bas-rhin' },
        { label: 'Étude Thermique', href: '/audit-energetique-bas-rhin' },
      ],
    },
